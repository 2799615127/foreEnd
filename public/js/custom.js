...
function background() {
    ...
    if ($(window).width() > 480) {
        ...
        $('.main').find(".about").backstretch("images/windy/1.jpg");
        $('.main').find(".albums").backstretch("images/windy/2.png");
        $('.main').find(".news").backstretch("images/windy/3.jpg");
        $('.main').find(".events").backstretch("images/windy/4.png");
        $('.main').find(".blog").backstretch("images/windy/5.jfif");
        $('.main').find(".contact").backstretch("images/windy/6.jpg");
    }
}
